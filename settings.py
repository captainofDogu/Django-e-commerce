...
MIDDLEWARE = [
    ...
    'kaft_clone.middleware.session_check_middleware', #SessionMiddleware den sonra koymamız lazım öncesine koyarsak çalışmaz çünkü yukarıdaki önce session işlemini oluşturmalı sonra biz çek işlemini yapmalıyız
